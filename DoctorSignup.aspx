<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="DoctorSignup.aspx.cs" Inherits="DoctorSignup" %>
      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="doctorhome.aspx">Health <span>Fitness</span></a>              
              <!-- IMG BASED LOGO  -->
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                <li class=""><a href="doctorhome.aspx">Home</a></li>
     ...
     <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ErrorMessage="*" ControlToValidate="FileUpload1" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <asp:TextBox ID="txtmail" runat="server" class="wp-form-control wpcf7-email" name="email" placeholder="Email" ></asp:TextBox>
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="txtdob" ForeColor="Red"></asp:RequiredFieldValidator>
                   ...
                   <br />
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" ControlToValidate="txtsp" ForeColor="Red"></asp:RequiredFieldValidator>
                 
                <asp:TextBox ID="txtsp" runat="server" class="wp-form-control wpcf7-text" name="special" placeholder="Specilization"></asp:TextBox>
                   <br />
